...
input :: [[Integer]]
input = [[116, 1470, 2610, 179, 2161, 2690, 831, 1824, 2361, 1050, 2201, 118, 145, 2275, 2625, 2333],
...
-- | Helper solution 1
-- finds all combinations of x and y in each sublist, and finds the two that
-- gives even division
checkSum :: [[Integer]] -> Integer
checkSum is =  sum $ concat[[x `div` y| x <- i, y <- i, x > y, x `mod` y == 0]
                                      | i <- is] 
